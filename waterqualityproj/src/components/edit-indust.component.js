...
export default class EditIndust extends Component {
    constructor(props) {
        super(props);
        ...
        this.state = ({
         ...
         //international registration number irn
            irn: '',
            category: '',
            industry_status:'',//closed or active
            location:'',
            no_violations:'',
            status:'',// pure or violated,
    ...
    componentDidMount(){
        axios.get('http://localhost:5000/Industries/'+this.props.match.params.id)
        .then(response=>{
          this.setState({
            ...
            industry_status: response.data.industry_status,
            location: response.data.location,
            no_violations: response.data.no_violations,
    ...
    onChangeirn(e) {
        ...
        axios.post('http://localhost:5000/industries/update/'+this.props.match.params.id, Industries)
    ...
    render() {
        return (
            ...
            <form onSubmit={this.onSubmit}>
                ...
                <div className="form-group">
                    <input type="submit" value="Edit Industry" className="btn btn-primary" />
                </div>
            </form>
        </div>
    )
